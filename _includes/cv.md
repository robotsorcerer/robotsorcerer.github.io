...
<p>While I may not be a single-issue researcher, a consistent throughline across my publication record involves developing mathematically grounded frameworks for autonomy: integrating <b>learning-enabled safety-critical control</b> and <b>systems representations</b> for <b>robust scalable decision-making (usually under uncertainty)</b>. My research arc spans MSR NYC, Amazon Robotics, UChicago, and UPenn. And yes, I am <i>w</i>eally 6'7".</p>

...
PS: Lekan Molu (he/him) is the double diminutive of Olalekan Ogunmolu, his full legal name. He would rather be addressed as Lekan Molu (pronounced **Lay-con Moh-loo**) in all professional and informal settings. You are welcome! (This intro is proudly not written by an AI!).

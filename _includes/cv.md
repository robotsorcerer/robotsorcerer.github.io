...
First-class, technological innovation-oriented full-stack roboticist (rigid, semi-rigid, and soft) whose algorithmics expertise encompasses the theory and practice of the AI, ML, and Control automation stack. Currently, I am a Senior Researcher within the Machine Learning group at Microsoft Research Core -- New York City. My research efforts span the complete ideation gamut of conceptualization, rigorous theoretical analysis, to abundant empirical and embodied proof-of-concept on real-world physical systems. Among other activities, I am a part of the robotics steering committee out of the [embodied AI research efforts](https://www.microsoft.com/en-us/research/collaboration/embodied-ai/people/) within the various cross-geographic teams throughout the company, active in the IEEE Control Systems Society and IEEE Robotics and Automation Society. Most of what I do and the questions that keep me up at night can be found here on my [research page](/research).

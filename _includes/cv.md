...
<div style="position: relative; margin-bottom: 1.5rem; background: url(/assets/research-bg.jpg) center/cover no-repeat; min-height: 280px; border-radius: 0.5rem; overflow: hidden;">
  ...
  <p style="position: relative; z-index: 5; padding: 0.75rem 1.75rem 1.5rem 1.75rem; margin: 0; font-size: 0.9rem; line-height: 1.65; color: #ffffff; text-shadow: 0 2px 8px rgba(0,0,0,0.5);">
    My research portfolio has a consistent <b>throughline</b> grounded in <b>principled frameworks</b> for autonomy: integrating <b>learning-enabled</b> and <b>safety-critical control</b> with <b>systems representation</b> for <b>robust scalable decision-making under uncertainty</b>. My research arc spans MSR NYC, Amazon Robotics, UPenn, and UTD/UTSW. A long time ago and prior to my academic career, I was in the manufacturing sector where I managed a team that integrated modern manufacturing processes into Coca-Cola PETs, cans, and bottle production control lines. 
  </p>
</div> 
...
<div class="bio-timeline-scroll">
  <div class="bio-timeline-wrapper">
    ...
    <div class="bio-tl-item">
      ...
      <div class="bio-tl-role">Hardware Dev Engr (Intern), <a href="https://www.amazonrobotics.com/#/" target=_blank>Advanced Robotics Lab, Amazon Robotics</a> MA.</div>
    </div>
    <div class="bio-tl-item">

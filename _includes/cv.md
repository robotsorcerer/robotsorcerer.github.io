...
First-class, technical innovation-oriented full-stack roboticist (rigid, semi-rigid, and soft). My algorithmics expertise encompasses the theory and practice of the AI, ML, and Control automation stack in virtual and physical automatons. Currently, I am a Senior Researcher within the Machine Learning group at Microsoft Research Core -- New York City. My research efforts span the complete ideation gamut from conceptualization, rigorous theoretical analysis, to abundant empirical and embodied proof-of-concept on real-world physical systems. Over time, I have worked on understanding the fundmental modeling blocks and and control of soft, deformable robots -- with applications to head and neck cancer coplanar radiation therapy (during my PhD and postdoc); RL state representation theory; and lately scalability of the numerical computation of safety certificates when controlling large-scale dynamical systems. These days, when I am among my friends, we say to one another, how do we create efficient numerical computation algorithms for unstructured, open-embodiment navigation and manipulation in modern automatons? Among other service activities within and without MSFT, I am a part of the robotics steering committee out of the [embodied AI research efforts](https://www.microsoft.com/en-us/research/collaboration/embodied-ai/people/) within the various cross-geographic teams throughout the company; helped seeded the current Cortex seminar series from a narrow focus to a company-wide appeal within MSFT. I am active in the IEEE Control Systems and IEEE Robotics and Automation Societies. Most of what I do and the questions that keep me up at night can be found here on my [research page](/research).

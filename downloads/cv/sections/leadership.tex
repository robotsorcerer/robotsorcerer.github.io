	\section{Peer Reviewing Activities (Research)}
	\cventry{2017-Present}{Reviews}{}{International Federation of Automatic Control (IFAC) Automatica Journal – IEEE Access Journal – Journal of Neural Computing and Applications (NCAA) – IFAC World Congress – IEEE International Conference on Robotics and Automation (ICRA) – IEEE International Conference on Decision and Control (CDC) – IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) – Dynamic Systems and Control Conference (DSCC) – American Control Conference (ACC) – International Conference on Machine Learning (ICML)}{}{}
	%

...
\cvline{}{As the gig economy develops, automating rote manufacturing tasks takes on more importance. There is a unique advantage that soft robots offer in real-world manipulation that rigid robots lack: morphological computation. Exploiting the morphological computation properties of soft manipulators yields simplified control laws and mechanical designs. My research goal is to provide robust models and controllers for soft robots that serve as better alternatives to the current manipulation technologies  that typically exhibit large flexure torques and high load-to-weight ratios. I am interested in designing 
\begin{inparaenum}[(1)]
\item robust models,
\item robust adaptive controllers, and
\item software simulation frameworks
\end{inparaenum}
to make it easier for engineers to test, verify and create soft manipulable devices as they intended.}{}

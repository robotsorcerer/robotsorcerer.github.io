...
% A
\cvline{}{As the gig economy evolves, automating rote tasks is taking on more priority in traditional business value chains. Robots have been particularly well-suited for this transformation. However, as humans increasingly share workspaces with rigid robot manipulators,  their low transportable loads, coupled with their links' large flexure torques magnify errors (e.g. from shoulder out to the end-effector), are harmful, and hamper their use for sophisticated control strategies that require minimizing or eliminating load-dependent errors. %The industry-standard stiffening process intended to enhance rigid robots' accuracy actually contributes to a high load-to-weight ratio and complicates the actuation system. 
Soft robots, however, exhibit distributed deformation, bending and twisting capabilities as well as a dexterous configuration space hyper-redundancy. These make them capable of flexible manipulation in delicate workspaces; their minimal resistance to applied strain and limited load-to-weight ratio make them choice mechanisms in sensitive automation applications. 
My research goal is to harness the unique advantage that soft robots offer in real-world manipulation that rigid robots lack: their morphological computation properties. Cleverly exploiting this property yields simplified control laws and human-friendly mechanical designs. I want to continue providing robust models and controllers for soft robots that serve as better alternatives to current rigid manipulation technologies. I am interested in designing 
\begin{inparaenum}[(1)]
\item robust models,

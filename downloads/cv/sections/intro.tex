...
% A
\cvline{}{As the gig economy evolves, automating rote tasks is taking on more priority in traditional business value chains. Robots have been particularly well-suited for this transformation. However, as humans increasingly share workspaces with rigid robot manipulators,  rigid robots' low transportable loads, coupled with the large flexure torques of their links magnify errors (e.g. from shoulder out to the end-effector). As such they  can be harmful to humans; this hampers their use in sophisticated control strategies that require minimizing or eliminating load-dependent errors. %The industry-standard stiffening process intended to enhance rigid robots' accuracy actually contributes to a high load-to-weight ratio and complicates the actuation system. 

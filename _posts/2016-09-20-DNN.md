...
<!-- It seems reasonable that a model of the human brain, which by the way is very good at nonlinear abstraction, should be adopted to complicated engineering modeling and design tasks.  -->

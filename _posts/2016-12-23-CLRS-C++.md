...
These are C++/Python solutions to some of the algorithm problems in the Introduction to Algorithms book by Cormen et. al. I wrote most of these while preparing for my google phone screening interview in December of 2016. Zhenchao Gan has some pseudocode solutions to similar problems on his [github page](https://github.com/gzc/CLRS). The codes have been proved to be correct. They are not extensively unit-tested and I would certaily welcome pull requests on improvements/enhancements of the codes.

Please note that it is not typical for google to directly ask you to implement most of these algorithms. But knowing these algorithms and how to implement them in code would help you in faster answering your questions.

These solutions have been tested using `g++ 4.8.4` with c++ 11/14 support on Ubuntu 14.04. The solutions are being developed over time. You may find a more solutions on this page if you check it at a a later time.

<a name='warm-up-questions'></a>
## `Soft-balls`

Usually in a google interview, there will be a first **<i>soft-ball</i>** question which you are expected to finish in good time before a **harder** question that will test your understanding of data structures. I gleaned these soft-ball questions from the internet and answer a few of them in this section. The first question is usually for the interviewer to figure out if you can actually write code. You are being hired to write code. Better be ready to prove it. If you do not pass this stage, you might not make it to the next stage(s) of interview. I've heard a lot of people flunk it at this stage. So it is worthwhile boning up on your basic coding skills. If you are a PhD student, you might be thinking coding is below you. But trust me, you <i>actually</i> have to practice writing the code without an IDE in order not to make mistakes during the whiteboard/google doc coding interview(s).

...
Please note that it is not typical for google to directly ask you to implement most of these algorithms. But knowing these algorithms and how to implement them in code could help you in faster answering your questions.
...
Usually in a google interview, there will be a first **<i>soft-ball</i>** question which you are expected to finish asap before a **harder** question that will test your understanding of data structures. I gleaned these soft-ball questions from the internet and answer a few of then in this section. The first question is usually for the interviewer to figure out if you can actually write code. You are being hired to write code. Better be ready to prove it. If you do not pass this stage, you might not make it to the next interview. I've heard a lot of people flunk it at this stage. So it is worthwhile boning up on your basic coding skills. If you are a PhD student, you might be thinking coding is below you. But trust me, you <i>actually</i> have to write the code to not make mistakes during the whiteboard/google doc coding interview(s).
